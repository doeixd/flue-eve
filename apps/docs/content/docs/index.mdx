...
- Eve-style agent files: `agent/instructions.md`, `agent/tools/*`, and
  `agent/connections/*`.
...
- You can author with Eve-style `agent/` files or Flue-native agents. Eve-style
  files are imported by the scaffold into Flue runtime files.
