...
flue-eve is not a fork of either project. It's a bridge that translates between
Eve's frontend contract and Flue's open runtime.

## What Eve provides (the contract)

Eve defines a **frontend developer experience**:
...
Use **flue-eve** when:
- You want the Eve HTTP/client contract without the Eve runtime
